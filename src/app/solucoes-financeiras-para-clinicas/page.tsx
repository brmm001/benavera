...
export const metadata: Metadata = {
  title: 'Soluções Financeiras para Clínicas Odontológicas e Médicas | Benavera',
  description:
    'Reduza o abandono de orçamentos e aumente a conversão de tratamentos particulares na sua clínica sem assumir risco de crédito ou antecipação burocrática.',
  alternates: { canonical: 'https://www.benavera.com.br/solucoes-financeiras-para-clinicas' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Soluções Financeiras para Clínicas | Benavera',
    description: 'Aumente o fechamento de orçamentos particulares na sua clínica.',
