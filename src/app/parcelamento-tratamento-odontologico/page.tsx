...
export const metadata: Metadata = {
  title: 'Parcelamento de Tratamento Odontológico | Alternativas de Pagamento',
  description:
    'Descubra como funciona o parcelamento de tratamentos odontológicos particulares: canais, próteses, ortodontia e reabilitação oral. Compare opções e simule.',
  alternates: { canonical: 'https://www.benavera.com.br/parcelamento-tratamento-odontologico' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Parcelamento de Tratamento Odontológico | Benavera',
    description: 'Encontre formas viáveis de parcelar seu tratamento dentário.',
