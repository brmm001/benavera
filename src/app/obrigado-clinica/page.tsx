...
export const metadata: Metadata = {
  title: 'Solicitação recebida | Benavera para Clínicas',
  description: 'Recebemos sua solicitação para participar do piloto Benavera. Nossa equipe entrará em contato em breve.',
