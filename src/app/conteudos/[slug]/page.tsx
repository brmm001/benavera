...
// Renderiza markdown simples como HTML
      ...
      <section style={{
        ...
        <div className="container-benavera">
          ...
          <div style={{ maxWidth: '720px', marginTop: '1.5rem' }}>
            <span className="badge badge-blue" style={{ marginBottom: '1.25rem', display: 'inline-block' }}>
          ...
          >
            ...
            <article style={{ maxWidth: '720px' }}>
              ...
              <div style={{
                ...
                <Link href="/simular" className="btn-primary" style={{ padding: '0.625rem 1.25rem', fontSize: '0.875rem' }}>
