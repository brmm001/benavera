...
export const metadata: Metadata = {
  title: {
    absolute: 'Benavera para clínicas | Recupere orçamentos perdidos',
  },
  description:
    'Descubra como clínicas de odontologia e cirurgia oferecem opções acessíveis de parcelamento aos pacientes e reduzem a perda de orçamentos.',
