...
export const metadata: Metadata = {
  title: 'Política Editorial e Diretrizes de Conteúdo | Benavera',
  description:
    'Conheça os padrões editoriais da Benavera: como pesquisamos, revisamos, citamos fontes oficiais e mantemos a transparência e a integridade de nossas publicações.',
  alternates: { canonical: 'https://www.benavera.com.br/politica-editorial' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Política Editorial | Benavera',
    description: 'Diretrizes éticas, critérios de fontes e processo de revisão da Benavera.',
