...
export const metadata: Metadata = {
  title: 'Parcelamento de Cirurgia Oftalmológica | Refrativa e Catarata',
  description:
    'Como parcelar cirurgia refrativa (LASIK/PRK), cirurgia de catarata com lentes intraoculares premium e procedimentos oftalmológicos particulares.',
  alternates: { canonical: 'https://www.benavera.com.br/parcelamento-cirurgia-oftalmologica' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Parcelamento de Cirurgia Oftalmológica | Benavera',
    description: 'Alternativas de parcelamento para cirurgias dos olhos.',
