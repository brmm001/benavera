...
export const metadata: Metadata = {
  title: 'Financiamento e Parcelamento de Implante Dentário | Benavera',
  description:
    'Saiba como pagar ou financiar implantes dentários unitários, múltiplos ou protocolo All-on-4. Compare entrada, prazos e parcelas mensais.',
  alternates: { canonical: 'https://www.benavera.com.br/financiamento-implante-dentario' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Financiamento de Implante Dentário | Benavera',
    description: 'Alternativas de parcelamento para implantes e próteses dentárias.',
...
const faqItems = [
  ...
  {
    question: 'O que é protocolo All-on-4 e como parcelar?',
    answer:
      'É a fixação de uma prótese completa em 4 a 6 implantes para quem perdeu todos os dentes de uma arcada. Por ser um tratamento de valor mais elevado, o parcelamento estendido (de 18 a 36 meses) é a forma mais comum de viabilização.',
  },
];
